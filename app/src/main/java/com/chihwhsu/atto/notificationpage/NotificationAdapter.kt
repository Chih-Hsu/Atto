...
class NotificationAdapter :
    ListAdapter<StatusBarNotification, NotificationAdapter.NotificationViewHolder>(object :
        DiffUtil.ItemCallback<StatusBarNotification>() {
    ...
    inner class NotificationViewHolder(val binding: ItemNotificationBinding) :
        ...
        fun bind(item: StatusBarNotification) {
            ...
            binding.textTitle.text = extras.get(TITLE).toString()
            binding.textContent.text = extras.get(TEXT).toString()
    ...
    companion object {
        private const val TITLE = "android.title"
        private const val TEXT = "android.text"
    }
}
